 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.rest.test.OpenAPIComplianceAssertion#getStrict <em>Strict</em>}</li>
 * </ul>
 *
 * @see edu.uoc.som.rest.test.TestPackage#getOpenAPIComplianceAssertion()
 * @model
 * @generated
 */
public interface OpenAPIComplianceAssertion extends ComplianceAssertion {
	 ...
	 * @see edu.uoc.som.rest.test.TestPackage#getOpenAPIComplianceAssertion_Strict()
	 * @model
	 * @generated
	 */
	Boolean getStrict();
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.rest.test.OpenAPIComplianceAssertion#getStrict <em>Strict</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
