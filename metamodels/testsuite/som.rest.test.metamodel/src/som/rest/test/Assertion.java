 ...
 * </p>
 * <ul>
 *   <li>{@link som.rest.test.Assertion#getErrorMessage <em>Error Message</em>}</li>
 * </ul>
 *
 * @see som.rest.test.TestPackage#getAssertion()
 * @model abstract="true"
 * @generated
 */
public interface Assertion extends EObject {
	 ...
	 * @see som.rest.test.TestPackage#getAssertion_ErrorMessage()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link som.rest.test.Assertion#getErrorMessage <em>Error Message</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
