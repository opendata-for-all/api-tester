 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.rest.test.SLAAssertion#getMaxTime <em>Max Time</em>}</li>
 * </ul>
 *
 * @see edu.uoc.som.rest.test.TestPackage#getSLAAssertion()
 * @model
 * @generated
 */
public interface SLAAssertion extends PerformanceAssertion {
	 ...
	 * @see edu.uoc.som.rest.test.TestPackage#getSLAAssertion_MaxTime()
	 * @model
	 * @generated
	 */
	Integer getMaxTime();
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.rest.test.SLAAssertion#getMaxTime <em>Max Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
